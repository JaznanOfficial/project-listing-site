...
const SingleCard = (props) => {
    const { name, imgLink, siteLink, frontSideCode, serverSideCode, usedTechnology } = props.singleCard;
    ...
    return (
        ...
        <div className="card d-flex flex-lg-row justify-content-center align-items-center text-lg-start shadow p-3 bg-dark">
                <div className="w-100">
                    <ReactImageTooltip image={imgLink}>
                ...
                <div className="w-100 text-center m-2 d-flex flex-lg-column justify-content-center align-items-center">
                    ...
                    <h1 className="mx-2"><a href={frontSideCode} title="Client Side Code" className="mx-2"><i class="fas fa-code text-light"></i></a> <a href={serverSideCode} title="Server Side Code" className="mx-2"><i class="fas fa-sitemap text-light"></i></a></h1>
                </div>
            </div>
        </Col>
